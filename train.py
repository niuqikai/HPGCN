...
#parser.add_argument('--seed', type=int, default=152, help='Random seed.')
...
parser.add_argument('--hidden', type=int, default=30,#30
...
def train(epoch):
    ...
    if epoch == 499:
        ...
        print(output_train.max(1)[1].type_as(labels).tolist())
        print(output_train)
...
for file_par in range(2,3):
    ...
    for parti in range(0,5):#5折交叉验证
        ...
        #auc_test_total += auc_test


    #acc_train_total /= 5.0
    #recall_train_total /= 5.0
    #precision_train_total /=5.0
    #F1_train_total /=5.0
    #auc_train_total /= 5.0

    #acc_test_total /= 5.0
    #recall_test_total /= 5.0
    #precision_test_total /= 5.0
    #F1_test_total /= 5.0
    #auc_test_total /= 5.0

    #print(acc_train_total, recall_train_total, precision_train_total, F1_train_total, auc_train_total)
    #print(acc_test_total, recall_test_total, precision_test_total, F1_test_total, auc_test_total)
